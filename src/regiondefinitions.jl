...
export europe8, eurasia38, scand3, scand4, eurasia21, china6, europe13, europe21, europe22, europe54, syntheticdemandregions,
        testreg, caspian, NUTS_Europe, eurasia92, africa, asia, europe, northamerica, oceania, southamerica, world, debug
...
const africa = [
    "AO"     GADM("Angola")
    "BF"     GADM("Burkina Faso")
    "BI"     GADM("Burundi")
    "BJ"     GADM("Benin")
    "BW"     GADM("Botswana")
    "CD"     GADM("Democratic Republic of the Congo")
    "CF"     GADM("Central African Republic")
    "CG"     GADM("Republic of Congo")
    "CI"     GADM("Côte d'Ivoire")
    "CM"     GADM("Cameroon")
    "CV"     GADM("Cape Verde")
    "DJ"     GADM("Djibouti")
    "DZ"     GADM("Algeria")
    "EG"     GADM("Egypt")
    "EH"     GADM("Western Sahara")
    "ER"     GADM("Eritrea")
    "ET"     GADM("Ethiopia")
    "GA"     GADM("Gabon")
    "GH"     GADM("Ghana")
    "GM"     GADM("Gambia")
    "GN"     GADM("Guinea")
    "GQ"     GADM("Equatorial Guinea")
    "GW"     GADM("Guinea-Bissau")
    "KE"     GADM("Kenya")
    "KM"     GADM("Comoros")
    "LR"     GADM("Liberia")
    "LS"     GADM("Lesotho")
    ...
    "SC"     GADM("Seychelles")
    "SD"     GADM("Sudan")
    "SL"     GADM("Sierra Leone")
    "SN"     GADM("Senegal")
    "SO"     GADM("Somalia")
    "SS"     GADM("South Sudan")
    "ST"     GADM("São Tomé and Príncipe")
    "SZ"     GADM("Swaziland")
    "TD"     GADM("Chad")
    "TG"     GADM("Togo")
    "TN"     GADM("Tunisia")
...
const asia = [
    ...
    "PS"    GADM("Palestina")
    "QA"    GADM("Qatar")
    "SA"    GADM("Saudi Arabia")
    "SG"    GADM("Singapore")
    "SY"    GADM("Syria")
    "TH"    GADM("Thailand")
    "TJ"    GADM("Tajikistan")
    "TL"    GADM("Timor-Leste")
    "TM"    GADM("Turkmenistan")
    "TR"    GADM("Turkey")
    "TW"    GADM("Taiwan")
    "UZ"    GADM("Uzbekistan")
    "VN"    GADM("Vietnam")
...
const europe = [
    ...
    "AT"    GADM("Austria")
    "AX"    GADM("Åland")
    "BA"    GADM("Bosnia and Herzegovina")
    "BE"    GADM("Belgium")
    "BG"    GADM("Bulgaria")
    "BY"    GADM("Belarus")
    "CH"    GADM("Switzerland")
    "CZ"    GADM("Czech Republic")
    "DE"    GADM("Germany")
    "DK"    GADM("Denmark")
    "EE"    GADM("Estonia")
    "ES"    GADM("Spain")
    "FI"    GADM("Finland")
    "FO"    GADM("Faroe Islands")
    "FR"    GADM("France")
    "GB"    GADM("United Kingdom")
    "GI"    GADM("Gibraltar")
    "GR"    GADM("Greece")
    "HR"    GADM("Croatia")
    "HU"    GADM("Hungary")
    ...
    "SM"    GADM("San Marino")
    "UA"    GADM("Ukraine")
    "VA"    GADM("Vatican City")
]

const northamerica = [
    "AG"    GADM("Antigua and Barbuda")
    "BB"    GADM("Barbados")
    "BQ"    GADM("Bonaire, Sint Eustatius and Saba")
    "BS"    GADM("Bahamas")
    "BZ"    GADM("Belize")
    "CA"    GADM("Canada")
    "CR"    GADM("Costa Rica")
    ...
    "NI"    GADM("Nicaragua")
    "PA"    GADM("Panama")
    "PM"    GADM("Saint Pierre and Miquelon")
    "PR"    GADM("Puerto Rico")
    "SV"    GADM("El Salvador")
    "TC"    GADM("Turks and Caicos Islands")
    "TT"    GADM("Trinidad and Tobago")
    # "US"    GADM("United States")
    "VC"    GADM("Saint Vincent and the Grenadines")
]
...
const oceania = [
    ...
    "GU"    GADM("Guam")
    "KI"    GADM("Kiribati")
    "MP"    GADM("Northern Mariana Islands")
    "NC"    GADM("New Caledonia")
    "NZ"    GADM("New Zealand")
    "PF"    GADM("French Polynesia")
    "PG"    GADM("Papua New Guinea")
    "PW"    GADM("Palau")
    "SB"    GADM("Solomon Islands")
    "TO"    GADM("Tonga")
    "VU"    GADM("Vanuatu")
    "WS"    GADM("Samoa")
]
...
const southamerica = [
    ...
    "CO"    GADM("Colombia")
    "EC"    GADM("Ecuador")
    "FK"    GADM("Falkland Islands")
    "GF"    GADM("French Guiana")
    "GY"    GADM("Guyana")
    "PE"    GADM("Peru")
    "PY"    GADM("Paraguay")
    "SR"    GADM("Suriname")
